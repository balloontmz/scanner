...
// cached from whatever global is present so that primary-test runners that stub it
 ...
 *
 * @param {Object} val The value to primary-test
...
/* WEBPACK VAR INJECTION */(function(global, process) {(function (global, undefined) {
    ...
    function canUsePostMessage() {
        // The primary-test against `importScripts` prevents this implementation from being installed inside a web worker,
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(150), __webpack_require__(151)))
...
module.exports = (
  ...
  // Standard browser envs have full support of the APIs needed to primary-test
  ...
  (function standardBrowserEnv() {
    ...
    *
    * @param {String} requestURL The URL to primary-test
 ...
 *
 * @param {string} url The URL to primary-test
...
if (inBrowser) {
  try {
    ...
    window.addEventListener('primary-test-passive', null, opts);
  } catch (e) {}
}
 ...
 * - primary-test
 * - primary-test[key]
 * - primary-test[test1[key]]
 * - primary-test["a"][key]
 * - xxx.primary-test[a[a].test1[key]]
 * - primary-test.xxx.a["asa"][test1[key]]
 *
 */
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(150), __webpack_require__(245).setImmediate))
